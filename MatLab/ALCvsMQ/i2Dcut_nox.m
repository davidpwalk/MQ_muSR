...
slidesteps = 1/yslide.steps;
% avoid error message if there are no second dimension, e.g. x2 is a single
% element
if yslide.steps == 0
    slidesteps = 0;
end
...
yslide.h=uicontrol(fh,'style','slider',...
    ...
    'callback',[yslide.call yslide.call2],'min',yslide.min,'max',yslide.max,'SliderStep',[slidesteps slidesteps],'value',1);
ctlh.yslide = yslide;
