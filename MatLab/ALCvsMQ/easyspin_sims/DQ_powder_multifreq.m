...
DQs = zeros(1024, length(freqs));
ZQs = zeros(1024, length(freqs));
...
figure(2); clf
hold on
pcolor(B-mean(B),freqs, transpose(DQs + ZQs))
shading flat


figure(3); clf
hold on
pcolor(B-mean(B),freqs, transpose(SQ1s + SQ2s))
shading flat
