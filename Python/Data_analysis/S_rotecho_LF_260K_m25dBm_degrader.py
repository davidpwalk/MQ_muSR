...
exp_c.append(np.arange(3789,3844))
exp_c.append(np.hstack((np.arange(3789, 3844),np.arange(3866,3878))))
...
normpls_ids = np.where((pulspars[:,3]==0)&(pulspars[:,4]==-25))[0]
rotecho_ids = np.where((pulspars[:,3]==1)&(pulspars[:,4]==-25))[0]


normpls13_ids = np.where((pulspars[:,3]==0)&(pulspars[:,4]==-13))[0]
rotecho13_ids = np.where((pulspars[:,3]==1)&(pulspars[:,4]==-13))[0]


plt.figure(16)
plt.clf()
plt.errorbar(pulspars[normpls_ids,2], amps[normpls_ids,1], yerr = stds[normpls_ids,1], label='post')
plt.errorbar(pulspars[normpls_ids,2], amps[normpls_ids,0], yerr = stds[normpls_ids,0], label= 'pre')
plt.errorbar(pulspars[normpls_ids,2], amps[normpls_ids,2], yerr = stds[normpls_ids,2], label = 'post longer')
...
plt.figure(17)
plt.clf()
plt.errorbar(pulspars[normpls_ids,2], amps[normpls_ids,1], yerr = stds[normpls_ids,1], marker='o', linestyle='', color='C2', label = 'norm' )
plt.errorbar(pulspars[rotecho_ids,2], amps[rotecho_ids,1], yerr = stds[rotecho_ids,1], marker='o', linestyle='', color='C1', label = 'rotecho' )
...
plt.figure(18)
plt.clf()
plt.errorbar(pulspars[normpls13_ids,2], amps[normpls13_ids,1], yerr = stds[normpls13_ids,1], marker='o', linestyle='', color='C2', label = 'norm13' )
plt.errorbar(pulspars[rotecho13_ids,2], amps[rotecho13_ids,1], yerr = stds[rotecho13_ids,1], marker='o', linestyle='', color='C1', label = 'rotecho13' )
...
plt.errorbar(pulspars[normpls13_ids,2], amps[normpls13_ids,1], yerr = stds[normpls13_ids,1], marker='o', linestyle='', color='C4', label = 'norm13' )
plt.errorbar(pulspars[rotecho13_ids,2], amps[rotecho13_ids,1], yerr = stds[rotecho13_ids,1], marker='o', linestyle='', color='C3', label = 'rotecho13' )
...
np.savez('S_260K_rotecho_tswp', pulspars=pulspars, amps = amps, stds = stds)
