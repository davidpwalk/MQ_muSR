...
exp_c.append(np.arange(3836,3866))


run_year = 2024
# alpha taken from run 2432
run_alpha = [1.05 , 1.05 , 1.05]
...
[df, df_x, df_header, df_err] = mufuns.get_asy_diff(runs = [runs[diffruns[0]], runs[diffruns[1]]], start_t = ev_lims[0], end_t = ev_lims[1], binning=diffdec, year = run_year, alpha = run_alpha)
