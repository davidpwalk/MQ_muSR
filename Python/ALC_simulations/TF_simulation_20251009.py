...
fig = px.line(x=powder_signals.sel(B=0.1, method='nearest').time, y=powder_signals.sel(B=1, method='nearest'), labels={'x': 'Time / ns',
                                                                                                                     'y': 'Signal'})
fig.show()
...
#%% Plot powder spectra
B = 0.1  # Tesla
fig = plot_powder_spectrum(powder_signals.sel(B=B).values)
